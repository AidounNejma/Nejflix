...
const ModalMainHeader = ({openedModalHeader, setIsOpendModalHeader, element}) => {
    ...
    //Constantes pour les vignettes et les videos
    ...
    return (
        ...
        <div id="wrapperModalMainHeader">

            <div className={`modal ${openedModalHeader ? '' : 'closed'}`}>
                ...
                <div className="modal-body">
                    ...
                    <div className="modal-content-second">
                        ...
                        <div className="genres">
                            ...
                            <span className="sub-title">{element.number}</span>
                        </div>
