...
const NejflixModal = ({opened, setIsOpened, setElement}) => {
                ...
                <div className="modal-body">
                    <div className="modal-content-first">
                        <div className="modal-description">
                            ...
                            <span> {new Date(setElement.dateOfCreation).getFullYear()}
                            </span>
                        ...
                        <p>{setElement.description}</p>
                    </div>

                    <div className="modal-content-second">
                        <div className="cast">
                            <span className="title">Entreprise: </span>
                            <span className="sub-title">{setElement.company} </span>
                        </div>

                        <div className="genres">
                            <span className="title">Frameworks: </span>
                            <span className="sub-title">{setElement.framework}</span>
                        </div>

                        <div className="show">
                            <span className="title">Langage: </span>
                            <span className="sub-title">{setElement.language} </span>
                        </div>
                    </div>
                </div>
            </div>
