...
const NejflixModal = ({opened, setIsOpened, setProject}) => {
        ...
        <div id="wrapperModal">
            ...
            <div className={`modal ${opened ? '' : 'closed'}`}>
                <div className="modal-header">
                    <video autoPlay loop muted={muted} poster="https://www.themoviedb.org/t/p/original/fOy6SL5Zs2PFcNXwqEPIDPrLB1q.jpg">
                    ...
                    <div className="header-content">
                        <div className="header-title">
                            ...
                            <div className="header-buttons">
                                ...
                                <button type="button" className="volume" onClick={handleToggleMute}>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="modal-body">
                    <div className="modal-content-first">
                        <div className="modal-description">
                            ...
                            <span> {new Date(setProject.dateOfCreation).getFullYear()}
                            </span>
                        ...
                        <p>{setProject.description}</p>
                    </div>

                    <div className="modal-content-second">
                        <div className="cast">
                            <span className="title">Entreprise: </span>
                            <span className="sub-title">{setProject.company} </span>
                        </div>

                        <div className="genres">
                            <span className="title">Frameworks: </span>
                            <span className="sub-title">{setProject.framework}</span>
                        </div>

                        <div className="show">
                            <span className="title">Langage: </span>
                            <span className="sub-title">{setProject.language} </span>
                        </div>
                    </div>
                </div>
            </div>
